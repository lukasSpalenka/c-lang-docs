...
tags: []
source: https://www.tutorialspoint.com/c_standard_library/c_function_fprintf.htm
author: 
---
...
| --- | --- |
| 1 |  **\-**<br>Left-justifies within the given field width; Right justification is the default (see width sub-specifier).<br> |
...
| 3 | <br>**(space)**<br>If no sign is written, a blank space is inserted before the value.<br> |
