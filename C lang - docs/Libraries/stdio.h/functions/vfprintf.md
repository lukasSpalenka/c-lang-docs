...
tags: []
source: https://www.tutorialspoint.com/c_standard_library/c_function_vfprintf.htm
author: 
---
...
The C library function **int vfprintf(FILE \*stream, const char \*format, va\_list arg)** sends formatted output to a stream using an argument list passed to it.
