...
tags: []
source: https://www.tutorialspoint.com/c_standard_library/c_function_vprintf.htm
author: 
---

# C library function - vprintf()
...
The C library function **int vprintf(const char \*format, va\_list arg)** sends formatted output to stdout using an argument list passed to it.
